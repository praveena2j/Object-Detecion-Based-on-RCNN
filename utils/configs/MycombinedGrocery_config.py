...
# data set config
__C.DATA.DATASET = "MycombinedGrocery"
__C.DATA.MAP_FILE_PATH = "../../DataSets/MycombinedGrocery"
...
__C.DATA.TEST_MAP_FILE_NO_ROI = "test_img_file_no_roi.txt"
__C.DATA.TEST_ROI_FILE = "test_roi_file.txt"
__C.DATA.NUM_TRAIN_IMAGES = 1234
__C.DATA.NUM_TEST_IMAGES = 1234
